...
public class ShapeRightZig extends Shape implements InterfaceShapeMotion{
	...
	GamePanel gamePanel;
	public ShapeRightZig(GamePanel gamePanel) {
		...
		shapePositionPoint[3] = blockPoint[gamePanel.xPointCount / 2 + 0][2];
	...
	public void changeShape() {
		...
		switch (shape) {
			...
			case 1:
			{   // 由向右形状变换为向上形状
				if ((x - 1 >= 0 ) && (y + 1 < gamePanel.yPointCount)
					 && y - 1 >= 0) {
					block[0] = blockPoint[x - 1][y - 1];
